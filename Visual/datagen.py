...
class ListDataset(data.Dataset):
    ...
    def collate_fn(self, batch):
        ...
        h = w = self.input_size
        num_imgs = len(imgs)
        inputs = torch.zeros(num_imgs, 1, h, w)
...
def test():
    ...
    dataset = ListDataset(root='./data/images',
                          list_file='./data/annotations_train.csv', train=True, transform=transform, input_size=(320,320))
    ...
    for images, loc_targets, cls_targets in dataloader:
        ...
        torchvision.utils.save_image(grid, 'a.png')
        break
